...
const GrievanceForm = () => {
  ...
  const fetchGrievanceTableData = async () => {
    try {
      setLoading(true);
      const res = await axios.get('https://uat-tscms.aptonline.in:8085/StudentServices/StudentRegistration/sp_student_grievance_details_select?StudentId=A01DF1777');
